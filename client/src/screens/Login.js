...
import { ReactComponent as MySvg } from '../images/signup.svg';
    ...
    <div className={styles.container}>
      <div className={styles.Signin_Signup}>
        <form action="" className={styles.sign_in_form}>
          ...
          <p className={styles.social_text}>Or Sign in with other social media platforms</p>
       ...
       <div className={styles.panels_container}>
            ...
            <div>
                <div className={styles.content} styles={{paddingLeft : 65, alignItems : 'center'}}>
                    ...
                    <h3>New here?</h3>
                    {/* <p> Sign up</p> */}
                    <button className={styles.btn}><Link to="/register" style={{color:'white'}}>Sign up</Link></button>
            </div>
